...
<header id="header">
        ...
        <div class="menu">
            <ul class="slk">
                <li><a href="form.html" class="form">Форма</a></li>
                <li><a href="grid.html" class="flex">Флекс</a></li>
            </ul>
        </div>
</header>
<main id="main">
            ...
            <div class="fio">
              ...
              <div class="info">
                  <div class="me">
                      ...
                      <br>Я учусь в колледже связи ПГУТИ на 3 курсе.<br>С недавнего времени заинтересовалась веб-разработкой
                      <br>и решила попробовать что-то новое для себя.
                      <br>В свободное время люблю смотреть фильмы и сериалы.
                      <br>Так же мне нравится путешествовать, но пока с этим немного проблематично(((
                  </div>
                <div class="opinion">
